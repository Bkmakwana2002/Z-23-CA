          ...
          <div class="w-full max-w-lg">
            <form class="bg-gradient-to-r from-gray-500 to-black-500/5 rounded shadow-lg px-8 pt-6 pb-8 mb-4 w-full">
              ...
              <div class="mb-6 text-center">
                <label
                  class="block text-white text-lg font-bold mb-2 text-center"
                  for="password"
                >
                  Password
                </label>
              ...
              <div class="flex justify-center">
                <button
                  class="m-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  type="button"
                >
                  Sign In
                </button>
                <a
                  class="mt-4 inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800"
                  href="#"
                >
                  Forgot Password?
                </a>
