              ...
              <div class="lg:col-span-2 text-white">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 text-lg">
                  ...
                  <div class="md:col-span-5">
                    ...
                    <input type="text" name="number" id="number" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                  </div>
                  ...
                  <div class="md:col-span-2">
                    ...
                    <div class="h-10 w-28 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                      ...
                      <input name="age" id="age" placeholder="0" class="px-2 text-center appearance-none outline-none text-gray-800 w-full bg-transparent" value="0" />
                  ...
                  <div class="md:col-span-3">
                    ...
                    <input type="text" name="college" id="college" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="" />
                  </div>
